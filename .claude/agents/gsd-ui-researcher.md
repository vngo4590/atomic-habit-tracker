...
Use template from `C:/Dev/atomic_habit_tracker/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Dev/atomic_habit_tracker/.claude/get-shit-done/templates/UI-SPEC.md`
