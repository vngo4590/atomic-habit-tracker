...
<required_reading>
@C:/Dev/atomic_habit_tracker/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/Dev/atomic_habit_tracker/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Dev/atomic_habit_tracker/.claude
                  → checks C:/Dev/atomic_habit_tracker/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Dev/atomic_habit_tracker/.claude/get-shit-done
                  → writes to C:/Dev/atomic_habit_tracker/.claude/get-shit-done/hooks/
...
@C:/Dev/atomic_habit_tracker/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/Dev/atomic_habit_tracker/.claude/get-shit-done/references/common-bug-patterns.md
