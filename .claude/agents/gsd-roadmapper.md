...
Reference full template: `C:/Dev/atomic_habit_tracker/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Dev/atomic_habit_tracker/.claude/get-shit-done/templates/state.md`.
