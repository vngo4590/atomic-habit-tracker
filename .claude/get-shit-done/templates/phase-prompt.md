...
<!-- For checkpoint task examples and patterns, see @C:/Dev/atomic_habit_tracker/.claude/get-shit-done/references/checkpoints.md -->
...
See `C:/Dev/atomic_habit_tracker/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/Dev/atomic_habit_tracker/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/Dev/atomic_habit_tracker/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
