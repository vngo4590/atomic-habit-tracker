...
```markdown
Read C:/Dev/atomic_habit_tracker/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Dev/atomic_habit_tracker/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Dev/atomic_habit_tracker/.claude/agents/gsd-ui-checker.md for instructions.
