...
```
Task(
  prompt="Read C:/Dev/atomic_habit_tracker/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Dev/atomic_habit_tracker/.claude/get-shit-done/templates/SECURITY.md`
