...
INSTALL_JS_GLOBAL="C:/Dev/atomic_habit_tracker/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Dev/atomic_habit_tracker/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
