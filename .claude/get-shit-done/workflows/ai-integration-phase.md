...
<required_reading>
@C:/Dev/atomic_habit_tracker/.claude/get-shit-done/references/ai-frameworks.md
@C:/Dev/atomic_habit_tracker/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/Dev/atomic_habit_tracker/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Dev/atomic_habit_tracker/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Dev/atomic_habit_tracker/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Dev/atomic_habit_tracker/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Dev/atomic_habit_tracker/.claude/agents/gsd-eval-planner.md for instructions.
