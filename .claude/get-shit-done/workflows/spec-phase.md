...
```bash
INIT=$(node "C:/Dev/atomic_habit_tracker/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Dev/atomic_habit_tracker/.claude/get-shit-done/templates/spec.md.
