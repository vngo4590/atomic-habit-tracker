...
Key references:
- @C:/Dev/atomic_habit_tracker/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @C:/Dev/atomic_habit_tracker/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/Dev/atomic_habit_tracker/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/Dev/atomic_habit_tracker/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/Dev/atomic_habit_tracker/.claude/get-shit-done/USER-PROFILE.md" "C:/Dev/atomic_habit_tracker/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/Dev/atomic_habit_tracker/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/Dev/atomic_habit_tracker/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @C:/Dev/atomic_habit_tracker/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/Dev/atomic_habit_tracker/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to C:/Dev/atomic_habit_tracker/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/Dev/atomic_habit_tracker/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/Dev/atomic_habit_tracker/.claude/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to C:/Dev/atomic_habit_tracker/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="C:/Dev/atomic_habit_tracker/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    C:/Dev/atomic_habit_tracker/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/Dev/atomic_habit_tracker/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        C:/Dev/atomic_habit_tracker/.claude/CLAUDE.md
```
