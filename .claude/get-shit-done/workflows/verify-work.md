...
Read and follow `C:/Dev/atomic_habit_tracker/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @C:/Dev/atomic_habit_tracker/.claude/get-shit-done/workflows/diagnose-issues.md
