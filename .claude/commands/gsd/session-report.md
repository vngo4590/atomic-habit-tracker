...
<execution_context>
@C:/Dev/atomic_habit_tracker/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @C:/Dev/atomic_habit_tracker/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
