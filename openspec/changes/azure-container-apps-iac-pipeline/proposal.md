...
- Add a custom domain rollout path covering domain ownership, Azure DNS or external DNS records, Container Apps hostname binding, managed TLS certificates, and app URL configuration.
...
- Requires Azure resources for Container Apps, PostgreSQL Flexible Server, ACR, Key Vault, managed identities, Log Analytics, Application Insights, and optionally Azure DNS for hosted custom domains.
