...
| `lib/stack.ts` | Habit stacking logic: `getStackChain`, `getStackRoot`, `wouldCreateCycle`, `linkStackAfter`, `stackRemovePatches`, `getVisibleStackHabit`, `groupHabitsByStack` |
