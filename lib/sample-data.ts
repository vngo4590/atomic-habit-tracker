...
export const SAMPLE_HABITS: Habit[] = [
  {
    ...
    loopCue: "After morning coffee, when I sit at the desk",
    loopCraving: "To feel like a curious, well-read person",
    loopResponse: "Open the current book to the bookmarked page",
    loopReward: "A clear mind and a single highlighted line in the margin",
  ...
  },
  {
    ...
    loopCue: "After lunch the calendar reminder fires at 1:15pm",
    loopCraving: "Mental reset, sunlight, the loop around the block",
    loopResponse: "Lace up the trainers by the door",
    loopReward: "Podcast episode I only let myself listen to while walking",
  ...
  },
  {
    ...
    loopCue: "Right after I brush my teeth at night",
    loopCraving: "Quiet, transition out of work brain",
    loopResponse: "Sit on the cushion, set a 5-minute timer",
    loopReward: "Falling asleep faster",
  ...
  },
  {
    ...
    loopCue: "Coffee + the notebook open on the kitchen table",
    loopCraving: "Clearing the mental cache before the day",
    loopResponse: "Three pages, longhand, no editing",
    loopReward: "A surprisingly honest sentence I underline at the end",
  ...
  },
  {
    ...
    loopCue: "End of normal shower, hand on the dial",
    loopCraving: "The dare itself; alertness",
    loopResponse: "Turn the dial to cold for 60 seconds",
    loopReward: "Wake-up jolt; small daily win banked before 8am",
  ...
  },
  {
    ...
    loopCue: "Waking up - the impulse to grab the phone",
    loopCraving: "Staying in my own head, not a feed",
    loopResponse: "Phone stays charging in the kitchen until 9am",
    loopReward: "A slow, owned hour",
...
export const SAMPLE_JOURNAL: JournalEntry[] = [
  {
    ...
    title: "Reading is starting to stick",
