...
export const LESSONS: Lesson[] = [
  ...
  {
    id: 25, chapter: 'Design', title: 'Start with the cue, not the craving',
    quote: 'A habit needs a clear first domino.',
    body: 'Motivation is slippery, but cues can be engineered. A glass on the desk, shoes by the door, a notebook open to the next blank page - each cue answers the question "what now?" before your mood gets a vote.',
    takeaway: 'Make the first visible signal so clear that the next action feels obvious.',
    practice: 'Choose one habit and place a physical cue where the habit should begin.',
    minutes: 2,
  },
  {
    id: 26, chapter: 'Design', title: 'Design the end of the habit',
    quote: 'The finish line teaches the brain whether to return.',
    body: 'People over-design the start and under-design the ending. A clean ending - log the rep, reset the space, take one breath, close the notebook - makes the habit feel complete and repeatable.',
    takeaway: 'Give your habit a satisfying landing, not just a starting line.',
    practice: 'Write the final 10 seconds of a habit as a repeatable closing ritual.',
    minutes: 2,
  },
  {
    id: 27, chapter: 'Design', title: 'Keep the setup under one minute',
    quote: 'If setup is heavy, repetition becomes rare.',
    body: 'A habit that requires searching, charging, cleaning, or deciding is already carrying hidden friction. The setup is part of the habit. Keep it light enough that you can begin on an ordinary tired day.',
    takeaway: 'Reduce setup until starting feels almost too easy to count.',
    practice: 'Time the setup for one habit. Remove one step before tomorrow.',
    minutes: 3,
  },
  {
    id: 28, chapter: 'Design', title: 'Let your calendar protect the habit',
    quote: 'What gets a place gets a chance.',
    body: 'A habit without a time slot competes with everything. A protected slot does not guarantee execution, but it removes negotiation. The calendar becomes a boundary around the identity you are practicing.',
    takeaway: 'Put the habit where your future self can find it.',
    practice: 'Add a recurring 10-minute block for one habit this week.',
    minutes: 2,
  },
  {
    id: 29, chapter: 'Recovery', title: 'Plan for low-energy days',
    quote: 'A good system includes the bad days.',
    body: 'If a habit only works when you feel rested, it is not yet designed for real life. A low-energy version preserves continuity: one page, one set, one sentence, one minute of cleanup.',
    takeaway: 'Your minimum version is not a compromise. It is continuity insurance.',
    practice: 'Define the smallest honest version of your most fragile habit.',
    minutes: 2,
  },
  {
    id: 30, chapter: 'Recovery', title: 'Use misses as diagnostics',
    quote: 'A miss is data before it is a judgment.',
    body: 'The useful question is not "what is wrong with me?" It is "where did the system break?" Maybe the cue was hidden, the time was unrealistic, the reward was absent, or the habit was too large.',
    takeaway: 'Treat every miss as a design note.',
    practice: 'Review your last missed habit and name the broken system part.',
    minutes: 3,
  },
  {
    id: 31, chapter: 'Recovery', title: 'Restart smaller than before',
    quote: 'The restart should be easier than the original plan.',
    body: 'After a gap, pride often pushes you to make up for lost time. That raises the bar exactly when confidence is lowest. Restart with a smaller rep and rebuild the rhythm first.',
    takeaway: 'Recovery is a rhythm problem before it is a volume problem.',
    practice: 'Pick one stalled habit and restart at half the previous size.',
    minutes: 2,
  },
  {
    id: 32, chapter: 'Recovery', title: 'Protect the second day back',
    quote: 'The comeback is not one day. It is two.',
    body: 'The first day back proves you can restart. The second day proves it was not a fluke. Make the second day back boring, small, and scheduled so the comeback becomes a pattern.',
    takeaway: 'After restarting, guard tomorrow before you celebrate today.',
    practice: 'When you restart a habit, schedule the next repeat immediately.',
    minutes: 2,
  },
  {
    id: 33, chapter: 'Mastery', title: 'Raise the standard slowly',
    quote: 'A habit grows best by small promotions.',
    body: 'Once a habit is stable, raise only one variable at a time: duration, intensity, complexity, or frequency. Raising all of them at once turns progress into a new source of friction.',
    takeaway: 'Upgrade the habit like a dial, not a switch.',
    practice: 'Choose one stable habit and raise exactly one variable by 5%.',
    minutes: 3,
  },
  {
    id: 34, chapter: 'Mastery', title: 'Track the leading measure',
    quote: 'Measure the action that predicts the result.',
    body: 'Weight, revenue, and skill are lagging measures. Reps, attempts, pages, workouts, and focused minutes are leading measures. Track the controllable action that makes the outcome more likely.',
    takeaway: 'Score the input before judging the output.',
    practice: 'For one goal, define the daily leading measure you can control.',
    minutes: 2,
  },
  {
    id: 35, chapter: 'Mastery', title: 'Make review part of the loop',
    quote: 'A habit without review can become stale.',
    body: 'Repetition builds consistency, but review keeps the habit useful. A monthly review asks: what is working, what is drifting, what should be removed, and what deserves the next small upgrade?',
    takeaway: 'Do not just repeat the habit. Refine the habit.',
    practice: 'Add a monthly review question to one habit note.',
    minutes: 3,
  },
  {
    id: 36, chapter: 'Mastery', title: 'Let identity compound quietly',
    quote: 'The strongest identities are built by repeated evidence.',
    body: 'At first, a habit feels like a task. Over time, the evidence accumulates until the action feels like something you do because of who you are. The shift is quiet, but it changes the cost of quitting.',
    takeaway: 'Keep casting small votes until the identity starts voting back.',
    practice: 'Write one sentence of evidence your current habits gave you this week.',
    minutes: 2,
  },
];
